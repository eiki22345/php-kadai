...
if (isset($_POST['submit'])) {
  try {
    ...
    $stmt_update->bindValue(':book_code',$_POST['book_code']);
    $stmt_update->bindValue(':book_name',$_POST['book_name']);
    $stmt_update->bindValue(':price',$_POST['price']);
    $stmt_update->bindValue(':stock_quantity',$_POST['stock_quantity']);
    $stmt_update->bindValue(':genre_code',$_POST['genre_code']);
    $stmt_update->bindValue(':id',$_GET['id']);
